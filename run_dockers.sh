...
apptainer exec --nv \
    ...
    --bind /vol/research/brainTumorST:/vol/research/brainTumorST \
    --bind /vol/research/scratch1/NOBACKUP/hh01116/:/vol/research/scratch1/NOBACKUP/hh01116/ \
    --bind /scratch/hh01116/:/scratch/hh01116/ \
    --env R_LIBS_USER="",R_ENVIRON_USER="" \
    /vol/research/scratch1/NOBACKUP/hh01116/docker_imgs/R_seurat5_with_pkgs.sif \
...
apptainer pull $VOL_NOBACKUP/docker_imgs/R_seurat5_with_pkgs.sif \
    ...
    oras://container-registry.surrey.ac.uk/shared-containers/apptainer-bioinformatics-r-seurat-5-with-recommended-pkgs:latest
